...
| PR-010 | Final sweep (dead code deleted; /loading route removed — leak dies with it; Biome re-enable sweep incl. a11y toggle fix; sw.js retained — documented exception; budget revisit; re-measure vs projections; doc reconciliation) | all prior | D5, D9 | implemented (GitHub PR pending) |
