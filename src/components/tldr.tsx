...
const TLDR: React.FC = () => {
  ...
  const sections: Section[] = [
    ...
    {
      header: 'now',
      content: `Finishing a computer science and mathematics degree while building the trading platform in the open. Off the clock: motorcycle rides, classic country, and too much philosophy. If any of this reads like your kind of engineering, or your kind of conversation, I'm easy to reach.`,
      extraCompenent: (
